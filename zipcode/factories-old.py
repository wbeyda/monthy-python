...
trades = ["Dog Catcher", "Groomer", "Carpenter", "Plumber", "Roofer", "Welder", "Cat Whisperer", "Hair Stylist", "Carnie", "Politician", "Accountant", "Programmer", "Artist", "Bartender", ]
...
class CustomerFactory(factory.django.DjangoModelFactory):
    class Meta:
        ...
        django_get_or_create = ("first_name", "last_name", "email", "phone_number", "address_line_1", "address_line_2", "city", "state", "zipcode", "subscribed", "special_notes",)
...
class ContractorFactory(factory.django.DjangoModelFactory):
    ...
    trade = fake.bs()
    secondaryTrades= random.choice(trades) 
    bio = fake.paragraph()
...
class ContractorScheduleFactory(factory.DjangoModelFactory):
    ...
    end_date = fake.date_time_between_dates(datetime_start = start_date, datetime_end= end_of_the_month())
